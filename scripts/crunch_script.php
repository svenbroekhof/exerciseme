<?php
    ...
    $trainingswaarde = $_POST["crunches"] * 6;
    ...
    $sql = "INSERT INTO `progressie` (`id`, `training`, `aantalMinuten`, `calorien`, `datum`) VALUES ( $id , 'Crunches', '" . $_POST["crunches"] . "' , $trainingswaarde , '" . date("d-m-Y") . "' );";
