<?php
    ...
    $trainingswaarde = $_POST["plankminuut"] * 4;
    ...
    $sql = "INSERT INTO `progressie` (`id`, `training`, `aantalMinuten`, `calorien`, `datum`) VALUES ( $id , 'Plank', '" . $_POST["plankminuut"] . "' , $trainingswaarde , '" . date("d-m-Y") . "' );";
